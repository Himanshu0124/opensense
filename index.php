            ...
            <div class="row" id="relocate">
                <div class="form-inline">
                    ...
                    <div class="form-check">
                        <input class="form-check-input ml-4" name="relocatecity" type="radio" name="exampleRadios" id="exampleRadios1" value="option1">
                        <label class="form-check-label pr-3" for="exampleRadios1">
                            Yes
                        </label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" name="relocatecity" type="radio" name="exampleRadios" id="exampleRadios2" value="option2">
